...
define('YAAMP_DBPASSWORD', 'TC3hEQJ77M3l0vzBOcOE0VlqXzHf0JTu');
...
define('YAAMP_BTCADDRESS', '1NqiKXeGczXDQyUBzrEtXCoKvwvbpXc9ZH');
define('YAAMP_SITE_URL', 'drakeblade.xyz');
define('YAAMP_STRATUM_URL', YAAMP_SITE_URL); // change if your stratum server is on a different host
define('YAAMP_SITE_NAME', 'TheCryptoPool');
define('YAAMP_ADMIN_EMAIL', '979199283@qq.com');
